...
export function ProductDetailsView({ product }) {
  ...
  useEffect(() => {
    if (product) {
      setPublish(product?.is_published);
    }
  }, [product]);
  ...
  return (
    <DashboardContent>
      <ProductDetailsToolbar
        backLink={paths.adminDashboard.product.root}
        editLink={paths.adminDashboard.product.edit(`${product?.id}`)}
        liveLink={paths.product.details(`${product?.slug}`)}
        publish={publish}
