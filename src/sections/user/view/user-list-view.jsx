...
// import { embedding } from 'src/actions/embedding';
...
const TABLE_HEAD = [
  { id: 'name', label: 'اسم کامل' },
  { id: 'phoneNumber', label: 'موبایل' },
...
export function UserListView() {
  const { users, userLoading, userEmpty } = useGetUsers(undefined);
  ...
  useEffect(() => {
    if (!(userLoading && userEmpty)) {
      setTableData(users);
      // const test = applyFilter({
      //   inputData: tableData,
  ...
  return (
    <>
      <DashboardContent>
        ...
        {/* <Button variant="outlined" onClick={handleEmbedding}>
          test
        </Button> */}
