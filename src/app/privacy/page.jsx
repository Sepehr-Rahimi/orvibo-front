    ...
    <Container maxWidth="md" sx={{ py: 8 }}>
      <Box>
        ...
        <Typography paragraph>
          حفظ امنیت و حریم خصوصی اطلاعات شخصی کاربران برای {CONFIG.site.name} از اهمیت بالایی
          برخوردار است. این سیاست توضیح می‌دهد چه اطلاعاتی از شما جمع‌آوری می‌شود، چگونه از آن
          استفاده می‌کنیم و چطور از آن محافظت می‌نماییم.
        </Typography>
        ...
        <Typography paragraph>
          {CONFIG.site.name} متعهد می‌شود اطلاعات شخصی کاربران را بدون رضایت کتبی آنان در اختیار
          اشخاص یا سازمان‌های دیگر قرار ندهد، مگر در موارد قانونی مانند ارائه اطلاعات به مراجع قضایی
          یا انتظامی با حکم رسمی.
        </Typography>
        ...
        <Typography paragraph>
          سایت {CONFIG.site.name} از کوکی‌ها جهت شخصی‌سازی تجربه کاربری و همچنین ابزارهای آماری
          مانند Google Analytics برای تحلیل رفتار کاربران استفاده می‌کند. کاربران می‌توانند تنظیمات
          کوکی مرورگر خود را در صورت تمایل تغییر دهند.
        </Typography>
        ...
        <Typography paragraph>
          {CONFIG.site.name} حق دارد در هر زمان سیاست حریم خصوصی را به‌روزرسانی نماید. تغییرات از
          طریق وب‌سایت به اطلاع کاربران خواهد رسید.
        </Typography>
      </Box>
    </Container>
  );
