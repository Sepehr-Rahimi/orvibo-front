...
import { OrderDetailsViewEn } from 'src/sections/admin/order/view/order-details-en-view';

// ----------------------------------------------------------------------

// export const metadata = { title: `اطلاعات سفارش | داشبورد - ${CONFIG.site.name}` };
...
export default function Page({ params }) {
  ...
  return (
    <>
      ...
      <OrderDetailsViewEn order={order} orderMutate={orderMutate} userRole={user.role} />
    </>
  );
}
