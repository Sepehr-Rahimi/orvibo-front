...
const assetURL = 'https://assets.minimals.cc/public';
...
export const _mock = {
  ...
  // Image
  image: {
    cover: (index) => `${assetURL}/assets/images/mock/cover/cover-${index + 1}.webp`,
    avatar: (index) => `${assetURL}/assets/images/mock/avatar/avatar-${index + 1}.webp`,
    travel: (index) => `${assetURL}/assets/images/mock/travel/travel-${index + 1}.webp`,
    course: (index) => `${assetURL}/assets/images/mock/course/course-${index + 1}.webp`,
    company: (index) => `${assetURL}/assets/images/mock/company/company-${index + 1}.webp`,
    product: (index) => `${assetURL}/assets/images/mock/m-product/product-${index + 1}.webp`,
    portrait: (index) => `${assetURL}/assets/images/mock/portrait/portrait-${index + 1}.webp`,
  },
};
